...
namespace ExchangeRateApp
{
    public partial class Form1 : Form
    {
        ...
        private dbConetxt kantor;
        public Form1()
        {
            InitializeComponent();
            client = new HttpClient();
            kantor = new dbConetxt();
        }
        ...
        {
            string currency = richTextBox1.Text.Trim(); // Pobierz wartoœæ waluty z richTextBox1
            float rate;

            // Spróbuj przekonwertowaæ wartoœæ z richTextBox2 na liczbê typu float
            if (float.TryParse(richTextBox3.Text.Trim(), out rate))
            {
                // Jeœli konwersja siê powiedzie, dodaj nowy wpis do bazy danych
                dbStructure dbRate = new dbStructure
                {
                    currency = currency,
                    rate = rate
            ...
            {
                // Jeœli konwersja siê nie powiedzie, wyœwietl komunikat o b³êdzie
        ...
        {
            string currency = richTextBox2.Text.Trim(); // Pobierz wartoœæ waluty z richTextBox1

            // SprawdŸ, czy waluta o podanej nazwie istnieje w bazie danych
        ...
        {
            string currencyToSearch = richTextBox4.Text.Trim(); // Pobierz wartoœæ waluty z richTextBox4

            // SprawdŸ, czy istnieje wpis o podanej walucie w bazie danych
